...
<div class="card card-custom gutter-b shadow-lg mt-10">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">{{ __('admin.reports.item_wise_sales') }}</span>
        </h3>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
            ...
            <table class="table table-checkable table-head-custom table-head-bg table-borderless table-vertical-center">
                ...
                <tr class="text-uppercase">
                    <th style="min-width: 150px" class="pl-7">
                        <span class="text-dark-75">{{ __($item.'.item') }}</span>
                    </th>
                    ...
                    <tr>
                        <td class="pl-0 py-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('admin.products.show', ['product' => $row->item_id ]) }}" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 ml-3 font-size-lg">{{ $row->item }}</a>
                                </div>
                            </div>
                        </td>
                        <td>
